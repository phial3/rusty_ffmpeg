...
#[cfg(feature = "ffmpeg6_1")]
AV_CH_LAYOUT_CONST!(AV_CH_LAYOUT_5POINT1POINT4_BACK,  AV_CH_LAYOUT_5POINT1POINT2_BACK|AV_CH_TOP_BACK_LEFT|AV_CH_TOP_BACK_RIGHT);
#[cfg(feature = "ffmpeg6_1")]
...
// 22.2 exists since 5.1; its C macro was rewritten in 6.1/8.0 but the mask
// value is unchanged, so expand it with 5.1-available terms only.
AV_CH_LAYOUT_CONST!(AV_CH_LAYOUT_22POINT2,            AV_CH_LAYOUT_5POINT1|AV_CH_BACK_LEFT|AV_CH_BACK_RIGHT|AV_CH_TOP_FRONT_LEFT|AV_CH_TOP_FRONT_RIGHT|AV_CH_TOP_BACK_LEFT|AV_CH_TOP_BACK_RIGHT|AV_CH_FRONT_LEFT_OF_CENTER|AV_CH_FRONT_RIGHT_OF_CENTER|AV_CH_TOP_SIDE_LEFT|AV_CH_TOP_SIDE_RIGHT|AV_CH_BACK_CENTER|AV_CH_LOW_FREQUENCY_2|AV_CH_TOP_FRONT_CENTER|AV_CH_TOP_CENTER|AV_CH_TOP_BACK_CENTER|AV_CH_BOTTOM_FRONT_CENTER|AV_CH_BOTTOM_FRONT_LEFT|AV_CH_BOTTOM_FRONT_RIGHT);

// Alias (FFmpeg 6.0+: defined as an alias of 5.1.2-back in 6.1, but the
// mask value is identical across 6.0~8.1, so define it standalone)
#[cfg(feature = "ffmpeg6")]
...
// FFmpeg 6.0+: MASK(8, 5POINT1_BACK|TFL|TFR); same value as
// 5POINT1POINT2_BACK (6.1+), defined standalone for the ffmpeg6 gate.
#[cfg(feature = "ffmpeg6")]
pub const AV_CHANNEL_LAYOUT_7POINT1_TOP_BACK: AVChannelLayout  = AV_CHANNEL_LAYOUT_MASK!(8, AV_CH_LAYOUT_5POINT1_BACK|AV_CH_TOP_FRONT_LEFT|AV_CH_TOP_FRONT_RIGHT);
